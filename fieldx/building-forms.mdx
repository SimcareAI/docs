...
Navigate to **Assignments → Create Assignment**. On the **Form** tab, click **Build New** to open the builder.

<Frame caption="Choose Form, then Build New to start a blank form. Upload converts an existing document with AI.">
